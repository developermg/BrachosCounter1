...
public class DaveningCategoriesAdapter extends BaseExpandableListAdapter {
    ...
    //Here's the constructor we'll use to pass in our calling activity's context, group items, and child items
    ...
    //I've always make a point to change it from "object" to whatever item I passed through the constructor
    @Override
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        //I passed a text string into an activity holding a getter/setter which I passed in through "ExpListGroupItems".
    ...
    public boolean childIsChecked(int groupPosition, int childPosition) {
        ...
        return getChecked != null && getChecked[childPosition];
    }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
        ...
        //I passed a text string into an activity holding a getter/setter which I passed in through "ExpListChildItems".
        //Here is where I call the getter to get that text
        ...
        if (convertView == null) {
            ...
            childViewHolder.mChildStringText = (TextView) convertView.findViewById(R.id.lblListItem);
            childViewHolder.mChildNumberText = (TextView) convertView.findViewById(R.id.lblListItemNumberValue);
            childViewHolder.mCheckBox = (CheckBox) convertView.findViewById(R.id.cbListItem);
            convertView.setTag(R.layout.davening_list_item, childViewHolder);
        } else
            childViewHolder = (ChildViewHolder) convertView.getTag(R.layout.davening_list_item);
        ...
        //You have to set the onCheckChangedListener to null before restoring check states because
        //each call to "setChecked" is accompanied by a call to the onCheckChangedListener
        childViewHolder.mCheckBox.setOnCheckedChangeListener(null);

        if (mChildCheckStates.containsKey(mGroupPosition)) {
            //if the hashmap mChildCheckStates<Integer, Boolean[]> contains the value of the parent
            //view (group) of this child (aka, the key), then retrive the boolean array getChecked[]
            ...
            //if the hashmap mChildCheckStates<Integer, Boolean[]> does not contain the value of the
            //parent view (group) of this child (aka, the key), then initialize getChecked[] as a
            //new boolean array and set it's size to the total number of children associated with
            //the parent group
